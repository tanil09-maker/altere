...
export async function searchDupes(productInfo, regionOptions = {}) {
  ...
  console.log('[dupe_finder] Total candidates before whitelist:', candidates.length);
  if (storeSet) console.log('[dupe_finder] Whitelist size:', storeSet.size, 'sample:', [...storeSet].slice(0, 5));
