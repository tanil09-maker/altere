...
export async function searchDupes(productInfo, regionOptions = {}) {
  ...
  console.log('[dupe_finder] storeSet type:', typeof storeSet, 'isSet:', storeSet instanceof Set, 'size:', storeSet?.size || 0);
  if (storeSet) console.log('[dupe_finder] storeSet sample:', [...(storeSet instanceof Set ? storeSet : [])].slice(0, 8));
