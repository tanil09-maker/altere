...
export async function initDB() {
  ...
  await db`DELETE FROM search_cache WHERE created_at < '2026-04-28'`; // v2: store whitelist + savings fix
  await db`DELETE FROM search_cache WHERE created_at < '2026-04-29'`; // v3: strict whitelist + dedup
}
