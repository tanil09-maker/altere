...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    ...
    nl: {
      ...
      'search.tab.camera': 'Maak foto', 'camera.start': 'Tik om camera te openen', 'camera.hint': 'Richt op een mode-item om dupes te vinden', 'camera.retake': 'Opnieuw', 'camera.use': 'Vind alternatieven', 'camera.error': 'Kan camera niet openen. Controleer de machtigingen.',
    ...
    fr: {
      ...
      'search.tab.camera': 'Prendre photo', 'camera.start': 'Appuyez pour ouvrir la cam\u00e9ra', 'camera.hint': 'Pointez vers un article de mode pour trouver des dupes', 'camera.retake': 'Reprendre', 'camera.use': 'Trouver des alternatives', 'camera.error': 'Impossible d\u2019acc\u00e9der \u00e0 la cam\u00e9ra. V\u00e9rifiez les permissions.',
    ...
    de: {
      ...
      'search.tab.camera': 'Foto machen', 'camera.start': 'Tippen um Kamera zu \u00f6ffnen', 'camera.hint': 'Auf ein Mode-Item richten, um Dupes zu finden', 'camera.retake': 'Nochmal', 'camera.use': 'Alternativen finden', 'camera.error': 'Kamera konnte nicht ge\u00f6ffnet werden. Bitte Berechtigungen pr\u00fcfen.',
    ...
    es: {
      ...
      'search.tab.camera': 'Tomar foto', 'camera.start': 'Toca para abrir la c\u00e1mara', 'camera.hint': 'Apunta a cualquier art\u00edculo de moda para encontrar dupes', 'camera.retake': 'Repetir', 'camera.use': 'Buscar alternativas', 'camera.error': 'No se pudo acceder a la c\u00e1mara. Verifica los permisos.',
    ...
    it: {
      ...
      'search.tab.camera': 'Scatta foto', 'camera.start': 'Tocca per aprire la fotocamera', 'camera.hint': 'Inquadra un articolo di moda per trovare dupes', 'camera.retake': 'Riprova', 'camera.use': 'Trova alternative', 'camera.error': 'Impossibile accedere alla fotocamera. Controlla i permessi.',
    ...
    ar: {
      ...
      'search.tab.camera': '\u0627\u0644\u062a\u0642\u0637 \u0635\u0648\u0631\u0629', 'camera.start': '\u0627\u0646\u0642\u0631 \u0644\u0641\u062a\u062d \u0627\u0644\u0643\u0627\u0645\u064a\u0631\u0627', 'camera.hint': '\u0648\u062c\u0651\u0647 \u0627\u0644\u0643\u0627\u0645\u064a\u0631\u0627 \u0646\u062d\u0648 \u0623\u064a \u0642\u0637\u0639\u0629 \u0623\u0632\u064a\u0627\u0621', 'camera.retake': '\u0625\u0639\u0627\u062f\u0629', 'camera.use': '\u0627\u0639\u062b\u0631 \u0639\u0644\u0649 \u0628\u062f\u0627\u0626\u0644', 'camera.error': '\u062a\u0639\u0630\u0651\u0631 \u0627\u0644\u0648\u0635\u0648\u0644 \u0644\u0644\u0643\u0627\u0645\u064a\u0631\u0627. \u062a\u062d\u0642\u0642 \u0645\u0646 \u0627\u0644\u0623\u0630\u0648\u0646\u0627\u062a.',
    ...
    zh: {
      ...
      'search.tab.link': '\u7c98\u8d34\u94fe\u63a5', 'search.tab.upload': '\u4e0a\u4f20\u7167\u7247', 'search.tab.text': '\u53d1\u73b0 & \u641c\u7d22', 'search.tab.camera': '\u62cd\u7167',
      ...
      'search.tab.camera': '\u62cd\u7167', 'camera.start': '\u70b9\u51fb\u6253\u5f00\u76f8\u673a', 'camera.hint': '\u5bf9\u51c6\u4efb\u4f55\u65f6\u5c1a\u5355\u54c1', 'camera.retake': '\u91cd\u62cd', 'camera.use': '\u627e\u66ff\u4ee3\u54c1', 'camera.error': '\u65e0\u6cd5\u8bbf\u95ee\u76f8\u673a\uff0c\u8bf7\u68c0\u67e5\u6743\u9650\u3002',
