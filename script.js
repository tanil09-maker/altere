...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'search.tab.reverse': 'Find original', 'search.placeholder.reverse': 'Describe an item, e.g. "Zara quilted chain bag"...', 'search.btnReverse': 'Find original', 'search.btnSource': 'Source it', 'search.subtab.describe': 'Describe', 'search.subtab.photo': 'Photo', 'search.subtab.link': 'Link',
    ...
    nl: {
      ...
      'search.tab.reverse': 'Vind origineel', 'search.btnReverse': 'Vind origineel', 'search.btnSource': 'Source it', 'search.subtab.describe': 'Beschrijf', 'search.subtab.photo': 'Foto', 'search.subtab.link': 'Link', 'search.placeholder.reverse': 'Beschrijf een item, bijv. "Zara gewatteerde tas"...',
    ...
    fr: {
      ...
      'search.tab.camera': 'Prendre photo', 'camera.start': 'Appuyez pour ouvrir la cam\u00e9ra', 'camera.hint': 'Pointez vers un article de mode pour trouver des dupes', 'camera.retake': 'Reprendre', 'camera.use': 'Trouver dupes', 'camera.error': 'Impossible d\u2019acc\u00e9der \u00e0 la cam\u00e9ra. V\u00e9rifiez les permissions.',
      ...
      'dotd.eyebrow': 'Trouvaille du Jour', 'dotd.original': 'L\u2019Original', 'dotd.dupe': 'Meilleur Dupe', 'dotd.vs': 'VS', 'dotd.btn': 'Trouver plus de dupes',
    ...
    de: {
      ...
      'dotd.eyebrow': 'Fund des Tages', 'dotd.original': 'Das Original', 'dotd.dupe': 'Bester Dupe', 'dotd.vs': 'VS', 'dotd.btn': 'Mehr Dupes finden',
    ...
    es: {
      ...
      'dotd.eyebrow': 'Hallazgo del D\u00eda', 'dotd.original': 'El Original', 'dotd.dupe': 'Mejor Dupe', 'dotd.vs': 'VS', 'dotd.btn': 'Encontrar m\u00e1s dupes',
    ...
    it: {
      ...
      'dotd.eyebrow': 'Scoperta del Giorno', 'dotd.original': 'L\u2019Originale', 'dotd.dupe': 'Miglior Dupe', 'dotd.vs': 'VS', 'dotd.btn': 'Trova pi\u00f9 dupes',
    ...
    ar: {
      ...
      'dotd.eyebrow': '\u0627\u0643\u062a\u0634\u0627\u0641 \u0627\u0644\u064a\u0648\u0645', 'dotd.original': '\u0627\u0644\u0623\u0635\u0644\u064a', 'dotd.dupe': '\u0623\u0641\u0636\u0644 \u0628\u062f\u064a\u0644', 'dotd.vs': 'VS', 'dotd.btn': '\u0627\u0639\u062b\u0631 \u0639\u0644\u0649 \u0627\u0644\u0645\u0632\u064a\u062f',
    ...
    zh: {
      ...
      'dotd.eyebrow': '\u6bcf\u65e5\u53d1\u73b0', 'dotd.original': '\u539f\u578b', 'dotd.dupe': '\u6700\u4f73\u66ff\u4ee3', 'dotd.vs': 'VS', 'dotd.btn': '\u627e\u66f4\u591a\u66ff\u4ee3',
